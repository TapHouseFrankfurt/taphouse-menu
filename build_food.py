...
@media(max-width:520px){
  .top .hrow{gap:6px}
  .top .cam{height:40px;max-width:140px}
  .top .emb{height:58px}
  .top .mid h1{font-size:22px}
  .top .mid .tag{font-size:10px}
}
@media(max-width:400px){
  .top .hrow{flex-direction:column;gap:10px}
  .top .cam{height:48px;max-width:190px}
  .top .emb{height:54px}
  .top .mid h1{font-size:27px;white-space:normal}
  .top .mid .tag{font-size:11px;letter-spacing:1px}
  .top .mid .sub{font-size:11px}
  .top .addr{font-size:10px}
}
